...
CREATE TABLE points (id integer primary key autoincrement not null, trial_id integer not null references trials (id), m integer not null, bias float not null, score float not null);
COMMIT;
