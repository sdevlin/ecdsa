...
BEGIN TRANSACTION;
CREATE TABLE trials (id integer primary key autoincrement not null, q text not null, x text not null, b integer not null, d integer not null, logW integer not null, seed integer not null, block_size integer not null, time_elapsed float);
