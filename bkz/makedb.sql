...
BEGIN TRANSACTION;
CREATE TABLE trials (id integer primary key autoincrement not null, q integer not null, x integer not null, b integer not null, d integer not null, logW integer not null, seed integer not null, block_size integer not null);
